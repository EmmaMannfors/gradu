########################################################################
#			Taking the N maps from the 
#			calculate_N code for 500, 350 and 
#			250 um (A) and convolving them to
#			350 um resolution
########################################################################
#				Jun 15, 2018
########################################################################
...
###################################
def band_350():
	print "You weren't supposed to convolve"
	print 'Angery cat is angery'
