...
in_160 = '/home/emma/gradu/data/All_data/PACS_160_Herschel/reproject_160_to_250/'
...
#Dropbox: Readme
normMatches = open('normalized_matches_250_160.txt','w')
normMatches.write('PACS 160		SPIRE 250\n')
########################################
...
#			continue
	####
		...
		pacs160 = in_160+change(matchList[2])
		psw = in_250+matchList[3]
		SCUBA = in_850+scuba
		locList = [pacs160,psw]
