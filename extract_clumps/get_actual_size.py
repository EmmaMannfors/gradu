################################################################################
#		Using distance estimates from GCCIV (+ other sources?) 
...
# Paths
#################################
file_in = '/home/emma/gradu/data/All_data/SCUBA_850/distances_to_sources/distances_to_SCUBA.txt'

dir_in = '/home/emma/gradu/data/All_data/SCUBA_850/clumps/extractResults/results/resultTables/'

dir_out = '/home/emma/gradu/data/All_data/SCUBA_850/distances_to_sources/size_of_clumps/'
...
with open(file_in) as f: 
	for line in f: 
		...
		outF = open(dir_out+field+'_size_of_clumps.txt','w')
		outF.write('# Distances from GCCIV paper\n')
		...
		outF.write('# Distance = '+str(d)+' + '+str(pl)+' - '+str(m)+' [kpc]'+'\n')#+'#'+'\n')
		...
		for l in doc: 
			...
			if round(rxplus,12) == round(rxmi,12): 
				outF.write('('+RX+' pm '+RXp+','+RY+' pm '+RYp+')'+'\n')
			else: 
